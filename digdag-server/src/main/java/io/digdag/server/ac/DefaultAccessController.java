        ...
        implements AccessController
{
    ...
    @Override
    public void checkPutProjectSecret(ProjectSecretTarget target, AuthenticatedUser user)
            throws AccessControlException
    { }

    @Override
    public void checkDeleteProjectSecret(ProjectSecretTarget target, AuthenticatedUser user)
            throws AccessControlException
    { }
