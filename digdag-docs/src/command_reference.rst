...
* archive.gcs.credentials.json.path (string. if not set, auth with local authentication information.)
* archive.gcs.credentials.json.content (string. if not set, auth with local authentication information.)
...
* log-server.gcs.credentials.json.path (string. if not set, auth with local authentication information.)
* log-server.gcs.credentials.json.content (string. if not set, auth with local authentication information.)
