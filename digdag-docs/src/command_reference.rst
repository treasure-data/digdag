...
* server.http.no-request-timeout (maximum allowed time for clients to keep a connection open without sending requests or receiving responses in milliseconds. default: 60000)
* server.http.request-parse-timeout (maximum allowed time of reading a HTTP request in milliseconds. this doesn't affect on reading request body. default: 30000)
* server.http.io-idle-timeout (maximum allowed idle time of reading HTTP request and writing HTTP response in milliseconds. default: 300000)
