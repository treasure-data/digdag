...
* archive.gcs.credentials.json.path (string. if not set, auth with local authentication information. If path and content are set, path has priority.)
* archive.gcs.credentials.json.content (string. if not set, auth with local authentication information. If path and content are set, path has priority.)
...
* log-server.gcs.credentials.json.path (string. if not set, auth with local authentication information. If path and content are set, path has priority.)
* log-server.gcs.credentials.json.content (string. if not set, auth with local authentication information. If path and content are set, path has priority.)
