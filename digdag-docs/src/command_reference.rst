...
* archive.gcs.credentials.json.path (string)
* archive.gcs.credentials.json.content (string)
...
* log-server.gcs.credentials.json.path (string)
* log-server.gcs.credentials.json.content (string)
