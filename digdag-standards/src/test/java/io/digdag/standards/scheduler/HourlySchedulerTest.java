...
public class HourlySchedulerTest extends SchedulerTestHelper
{
    ...
    {
        return new HourlySchedulerFactory(configHelper).newScheduler(newConfig(pattern, start, end), ZoneId.of(timeZone));
    }
    ...
    public void firstScheduleTimeStartEnd()
    {
        // check start
        {
            Instant currentTime = instant("2016-02-03 17:14:59 +0000");
            assertThat(
                    newScheduler("15:00", "UTC", Optional.of("2016-03-01"), Optional.of("2016-03-31")).getFirstScheduleTime(currentTime),
                    is(ScheduleTime.of(
                            instant("2016-03-01 00:00:00 +0000"),
                            instant("2016-03-01 00:15:00 +0000"))));
        }
        // check start
        {
            Instant currentTime = instant("2016-03-01 00:15:01 +0000");
            assertThat(
                    newScheduler("15:00", "UTC", Optional.of("2016-03-01"), Optional.of("2016-03-31")).getFirstScheduleTime(currentTime),
                    is(ScheduleTime.of(
                            instant("2016-03-01 01:00:00 +0000"),
                            instant("2016-03-01 01:15:00 +0000"))));
        }
        // check end
        {
            Instant currentTime = instant("2016-03-31 23:15:00 +0000");
            assertThat(
                    newScheduler("15:00", "UTC", Optional.of("2016-03-01"), Optional.of("2016-03-31")).getFirstScheduleTime(currentTime),
                    is(ScheduleTime.of(
                            instant("2016-03-31 23:00:00 +0000"),
                            instant("2016-03-31 23:15:00 +0000"))));
        }
        // check end
        {
            Instant currentTime = instant("2016-03-31 23:15:01 +0000");
            assertThat(
                    newScheduler("15:00", "UTC", Optional.of("2016-03-01"), Optional.of("2016-03-31")).getFirstScheduleTime(currentTime),
                    is(ScheduleTime.of(
    ...
    public void nextScheduleTimeStartEnd()
    {
        //check start
        {
            Instant lastScheduleTime1 = instant("2016-02-29 05:00:00 +0900");
            assertThat(
                    newScheduler("15:00", "Asia/Tokyo", Optional.of("2016-03-01"), Optional.of("2016-03-31")).nextScheduleTime(lastScheduleTime1),
                    is(ScheduleTime.of(
                            instant("2016-03-01 00:00:00 +0900"),
                            instant("2016-03-01 00:15:00 +0900"))));
        }
        //check start
        {
            Instant lastScheduleTime1 = instant("2016-02-29 23:15:00 +0900");
            assertThat(
                    newScheduler("15:00", "Asia/Tokyo", Optional.of("2016-03-01"), Optional.of("2016-03-31")).nextScheduleTime(lastScheduleTime1),
                    is(ScheduleTime.of(
                            instant("2016-03-01 00:00:00 +0900"),
        ...
        //check start
        {
            Instant lastScheduleTime1 = instant("2016-03-01 00:15:00 +0900");
            assertThat(
                    newScheduler("15:00", "Asia/Tokyo", Optional.of("2016-03-01"), Optional.of("2016-03-31")).nextScheduleTime(lastScheduleTime1),
                    is(ScheduleTime.of(
                            instant("2016-03-01 01:00:00 +0900"),
                            instant("2016-03-01 01:15:00 +0900"))));
        }
        //check end
        {
            Instant lastScheduleTime1 = instant("2016-03-31 22:15:00 +0900");
            assertThat(
                    newScheduler("15:00", "Asia/Tokyo", Optional.of("2016-03-01"), Optional.of("2016-03-31")).nextScheduleTime(lastScheduleTime1),
                    is(ScheduleTime.of(
                            instant("2016-03-31 23:00:00 +0900"),
                            instant("2016-03-31 23:15:00 +0900"))));
        }
        //check end
        {
            Instant lastScheduleTime1 = instant("2016-03-31 23:15:00 +0900");
            assertThat(
                    newScheduler("15:00", "Asia/Tokyo", Optional.of("2016-03-01"), Optional.of("2016-03-31")).nextScheduleTime(lastScheduleTime1),
                    is(ScheduleTime.of(
                            instant("9999-01-01 00:00:00 +0000"),
        ...
        //check end
        {
            Instant lastScheduleTime1 = instant("2016-04-01 00:15:00 +0900");
            assertThat(
                    newScheduler("15:00", "Asia/Tokyo", Optional.of("2016-03-01"), Optional.of("2016-03-31")).nextScheduleTime(lastScheduleTime1),
                    is(ScheduleTime.of(
                            instant("9999-01-01 00:00:00 +0000"),
    ...
    public void lastScheduleTimeStartEnd()
    {
        // lastScheduleTime calculation ignore start/end
        {
            ...
            assertThat(
                    newScheduler("15:00", "Asia/Tokyo", Optional.of("2016-03-01"), Optional.of("2016-03-31")).lastScheduleTime(currentScheduleTime),
                    is(ScheduleTime.of(
                            instant("2016-02-28 23:00:00 +0900"),
                            instant("2016-02-28 23:15:00 +0900"))));
        }
        {
            ...
            assertThat(
                    newScheduler("15:00", "Asia/Tokyo", Optional.of("2016-03-01"), Optional.of("2016-03-31")).lastScheduleTime(currentScheduleTime),
                    is(ScheduleTime.of(
                            instant("2016-02-29 23:00:00 +0900"),
                            instant("2016-02-29 23:15:00 +0900"))));
        }
        {
            ...
            assertThat(
                    newScheduler("15:00", "Asia/Tokyo", Optional.of("2016-03-01"), Optional.of("2016-03-31")).lastScheduleTime(currentScheduleTime),
                    is(ScheduleTime.of(
                            instant("2016-03-01 23:00:00 +0900"),
                            instant("2016-03-01 23:15:00 +0900"))));
        }
        {
            ...
            assertThat(
                    newScheduler("15:00", "Asia/Tokyo", Optional.of("2016-03-01"), Optional.of("2016-03-31")).lastScheduleTime(currentScheduleTime),
                    is(ScheduleTime.of(
                            instant("2016-03-30 23:00:00 +0900"),
                            instant("2016-03-30 23:15:00 +0900"))));
        }
        {
        ...
        }
        {
            ...
            assertThat(
                    newScheduler("15:00", "Asia/Tokyo", Optional.of("2016-03-01"), Optional.of("2016-03-31")).lastScheduleTime(currentScheduleTime),
                    is(ScheduleTime.of(
                            instant("2016-04-01 23:00:00 +0900"),
                            instant("2016-04-01 23:15:00 +0900"))));
        }
    }
}
