        ...
        extends AutoCloseable
{
    ...
    GetLogEventsResult getLogWithoutNextToken(String groupName, String streamName);

    GetLogEventsResult getLogWithoutStartFromHeadAndNextToken(String groupName, String streamName);
