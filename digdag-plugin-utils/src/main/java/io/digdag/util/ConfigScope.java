...
public class ConfigScope
{
    ...
    private final Set<String> secretScopedKeys;
            ...
            SecretProvider secrets)
    {
        ...
        this.secretScopedKeys = buildScopedKeys(scope, configSelector.getSecretAccessList());
    ...
    {
        if (secretScopedKeys.contains(scopedKey) || secretOnlyScopedKeys.contains(scopedKey)) {
