...
public class PluginLoader
{
    ...
    public PluginLoader(Path localRepositoryPath)
    {
        this.system = newRepositorySystem();
        this.session = newRepositorySystemSession(system, localRepositoryPath);
    }

    public PluginFactorySet load(Spec spec)
    {
        if (spec.getDependencies().isEmpty()) {
            return PluginFactorySet.empty();
        }
        ...
        return new PluginFactorySet(builder.build());
    }
    ...
    private ClassLoader buildPluginClassLoader(List<ArtifactResult> artifactResults)
    {
        ...
        return new PluginClassLoader(urls.build(), PluginLoader.class.getClassLoader(),
