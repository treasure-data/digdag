...
public class StorageLogServerFactory
    implements LogServerFactory
{
    ...
    @Inject
    public StorageLogServerFactory(StorageManager storageManager, Config systemConfig)
    {
        this.type = systemConfig.get("log-server.type", String.class);
        this.storage = storageManager.create(type, systemConfig, "log-server.");
    ...
    {
        return new StorageFileLogServer();
    }
