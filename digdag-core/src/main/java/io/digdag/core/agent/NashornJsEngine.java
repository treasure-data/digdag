    ...
    implements JsEngine
{
    ...
    {
        // Delay ScriptEngine creation until Evaluator.evaluate() called by newTemplateInvocable()
        return (code, scopedParams, jsonMapper) -> invokeTemplate(newTemplateInvocable(params), code, scopedParams, jsonMapper);
    }
