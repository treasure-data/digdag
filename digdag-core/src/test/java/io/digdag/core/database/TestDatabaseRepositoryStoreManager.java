...
public class TestDatabaseRepositoryStoreManager
{
    ...
    private static void assertNotFound(MayNotFound r)
    {
        try {
            r.run();
            fail();
    ...
    private static void assertConflict(MayConflict r)
    {
        try {
            r.run();
            fail();
    ...
    private static void assertNotConflict(MayConflict r)
    {
        try {
            r.run();
        }
    ...
    private static void assertEmpty(Collection<?> r)
    {
